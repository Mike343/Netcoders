...
namespace Coders.Tests.Services.Fakes
{
	public class FakeUserRepository : IRepository<User>
	{
		public FakeUserRepository()
		{
			...
			{
				new User { Id = 1, Name = "test", Preference = new UserPreference { Id = 1 } }
			};
		}

		private IList<User> Values
		{
			get;
			set;
		}
		...
		public IPagedCollection<User> GetPaged(ISpecification<User> specification)
		{
			...
			return new PagedCollection<User>(entities.ToList(), specification.PageOrDefault, specification.LimitOrDefault, total);
		}
